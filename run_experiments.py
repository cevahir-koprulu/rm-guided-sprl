...
arguments = [
            ...
            ['--train', '--eval', '--env', 'half_cheetah_3d', '--type', 'rm_guided_self_paced', '--TARGET_TYPE', 'narrow', '--product_cmdp', '--seed', '1', '--ZETA', '1.', '--true_rewards'],
            ['--train', '--eval', '--env', 'half_cheetah_3d', '--type', 'rm_guided_self_paced', '--TARGET_TYPE', 'narrow', '--product_cmdp', '--seed', '2', '--ZETA', '1.', '--true_rewards'],
            ['--train', '--eval', '--env', 'half_cheetah_3d', '--type', 'rm_guided_self_paced', '--TARGET_TYPE', 'narrow', '--product_cmdp', '--seed', '3', '--ZETA', '1.', '--true_rewards'],
            ['--train', '--eval', '--env', 'half_cheetah_3d', '--type', 'rm_guided_self_paced', '--TARGET_TYPE', 'narrow', '--product_cmdp', '--seed', '4', '--ZETA', '1.', '--true_rewards'],
            ['--train', '--eval', '--env', 'half_cheetah_3d', '--type', 'rm_guided_self_paced', '--TARGET_TYPE', 'narrow', '--product_cmdp', '--seed', '5', '--ZETA', '1.', '--true_rewards'],
            
            ['--train', '--eval', '--env', 'half_cheetah_3d', '--type', 'self_paced', '--TARGET_TYPE', 'narrow', '--product_cmdp', '--seed', '1', '--ZETA', '4.', '--true_rewards'],
            ['--train', '--eval', '--env', 'half_cheetah_3d', '--type', 'self_paced', '--TARGET_TYPE', 'narrow', '--product_cmdp', '--seed', '2', '--ZETA', '4.', '--true_rewards'],
            ['--train', '--eval', '--env', 'half_cheetah_3d', '--type', 'self_paced', '--TARGET_TYPE', 'narrow', '--product_cmdp', '--seed', '3', '--ZETA', '4.', '--true_rewards'],
            ['--train', '--eval', '--env', 'half_cheetah_3d', '--type', 'self_paced', '--TARGET_TYPE', 'narrow', '--product_cmdp', '--seed', '4', '--ZETA', '4.', '--true_rewards'],
            ['--train', '--eval', '--env', 'half_cheetah_3d', '--type', 'self_paced', '--TARGET_TYPE', 'narrow', '--product_cmdp', '--seed', '5', '--ZETA', '4.', '--true_rewards'],

            ['--train', '--eval', '--env', 'half_cheetah_3d', '--type', 'self_paced', '--TARGET_TYPE', 'narrow', '--seed', '1', '--ZETA', '4.', '--true_rewards'],
            ['--train', '--eval', '--env', 'half_cheetah_3d', '--type', 'self_paced', '--TARGET_TYPE', 'narrow', '--seed', '2', '--ZETA', '4.', '--true_rewards'],
            ['--train', '--eval', '--env', 'half_cheetah_3d', '--type', 'self_paced', '--TARGET_TYPE', 'narrow', '--seed', '3', '--ZETA', '4.', '--true_rewards'],
            ['--train', '--eval', '--env', 'half_cheetah_3d', '--type', 'self_paced', '--TARGET_TYPE', 'narrow', '--seed', '4', '--ZETA', '4.', '--true_rewards'],
            ['--train', '--eval', '--env', 'half_cheetah_3d', '--type', 'self_paced', '--TARGET_TYPE', 'narrow', '--seed', '5', '--ZETA', '4.', '--true_rewards'],

            ['--train', '--eval', '--env', 'half_cheetah_3d', '--type', 'default', '--TARGET_TYPE', 'narrow', '--product_cmdp', '--seed', '1'],
            ['--train', '--eval', '--env', 'half_cheetah_3d', '--type', 'default', '--TARGET_TYPE', 'narrow', '--product_cmdp', '--seed', '2'],
            ['--train', '--eval', '--env', 'half_cheetah_3d', '--type', 'default', '--TARGET_TYPE', 'narrow', '--product_cmdp', '--seed', '3'],
            ['--train', '--eval', '--env', 'half_cheetah_3d', '--type', 'default', '--TARGET_TYPE', 'narrow', '--product_cmdp', '--seed', '4'],
            ['--train', '--eval', '--env', 'half_cheetah_3d', '--type', 'default', '--TARGET_TYPE', 'narrow', '--product_cmdp', '--seed', '5'],
            ...
            ['--train', '--eval', '--env', 'two_door_discrete_2d', '--type', 'rm_guided_self_paced', '--TARGET_TYPE', 'wide', '--product_cmdp', '--seed', '1', '--ZETA', '0.96', '--true_rewards'],
            ['--train', '--eval', '--env', 'two_door_discrete_2d', '--type', 'rm_guided_self_paced', '--TARGET_TYPE', 'wide', '--product_cmdp', '--seed', '2', '--ZETA', '0.96', '--true_rewards'],
            ['--train', '--eval', '--env', 'two_door_discrete_2d', '--type', 'rm_guided_self_paced', '--TARGET_TYPE', 'wide', '--product_cmdp', '--seed', '3', '--ZETA', '0.96', '--true_rewards'],
            ['--train', '--eval', '--env', 'two_door_discrete_2d', '--type', 'rm_guided_self_paced', '--TARGET_TYPE', 'wide', '--product_cmdp', '--seed', '4', '--ZETA', '0.96', '--true_rewards'],
            ['--train', '--eval', '--env', 'two_door_discrete_2d', '--type', 'rm_guided_self_paced', '--TARGET_TYPE', 'wide', '--product_cmdp', '--seed', '5', '--ZETA', '0.96', '--true_rewards'],
            
            ['--train', '--eval', '--env', 'two_door_discrete_2d', '--type', 'self_paced', '--TARGET_TYPE', 'wide', '--product_cmdp', '--seed', '1', '--ZETA', '1.2', '--true_rewards'],
            ['--train', '--eval', '--env', 'two_door_discrete_2d', '--type', 'self_paced', '--TARGET_TYPE', 'wide', '--product_cmdp', '--seed', '2', '--ZETA', '1.2', '--true_rewards'],
            ['--train', '--eval', '--env', 'two_door_discrete_2d', '--type', 'self_paced', '--TARGET_TYPE', 'wide', '--product_cmdp', '--seed', '3', '--ZETA', '1.2', '--true_rewards'],
            ['--train', '--eval', '--env', 'two_door_discrete_2d', '--type', 'self_paced', '--TARGET_TYPE', 'wide', '--product_cmdp', '--seed', '4', '--ZETA', '1.2', '--true_rewards'],
            ['--train', '--eval', '--env', 'two_door_discrete_2d', '--type', 'self_paced', '--TARGET_TYPE', 'wide', '--product_cmdp', '--seed', '5', '--ZETA', '1.2', '--true_rewards'],
            
            ['--train', '--eval', '--env', 'two_door_discrete_2d', '--type', 'self_paced', '--TARGET_TYPE', 'wide', '--seed', '1', '--ZETA', '1.2', '--true_rewards'],
            ['--train', '--eval', '--env', 'two_door_discrete_2d', '--type', 'self_paced', '--TARGET_TYPE', 'wide', '--seed', '2', '--ZETA', '1.2', '--true_rewards'],
            ['--train', '--eval', '--env', 'two_door_discrete_2d', '--type', 'self_paced', '--TARGET_TYPE', 'wide', '--seed', '3', '--ZETA', '1.2', '--true_rewards'],
            ['--train', '--eval', '--env', 'two_door_discrete_2d', '--type', 'self_paced', '--TARGET_TYPE', 'wide', '--seed', '4', '--ZETA', '1.2', '--true_rewards'],
            ['--train', '--eval', '--env', 'two_door_discrete_2d', '--type', 'self_paced', '--TARGET_TYPE', 'wide', '--seed', '5', '--ZETA', '1.2', '--true_rewards'],
