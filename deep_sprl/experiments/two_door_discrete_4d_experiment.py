...
class TwoDoorDiscrete4DExperiment(AbstractExperiment):
    ...
    def create_self_paced_teacher(self):
        ...
        if self.curriculum.self_paced():
            ...
            return SelfPacedTeacher(self.TARGET_MEAN.copy(), self.TARGET_VARIANCE_TYPES[self.TARGET_TYPE].copy(), self.INITIAL_MEAN.copy(),
            ...
            return RMguidedSelfPacedTeacher(self.TARGET_MEAN.copy(),
                                            ...
                                            kl_threshold=self.KL_THRESHOLD, use_avg_performance=True, seed=self.seed)
        else:
